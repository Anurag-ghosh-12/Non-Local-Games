...
def s12(p): return p
def s13(p): return p**2-2*p+1
def s14(p): return p**2-2*p+1
...
# Customize the plot
plt.title("Probability Expressions for 7 Successful Outcomes", fontsize=16)
